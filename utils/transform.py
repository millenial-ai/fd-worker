...
from .CONST import BIN_PATH, NUMERICAL_FEATURES, CATEGORICAL_FEATURES, UNKNOWN
import logging
...
xgb_features_encoders = {
    key: load_pkl(os.path.join(BIN_PATH, get_feature_encoder_name(key)))
    for key in CATEGORICAL_FEATURES
}
xgb_numerical_scalers = {
    key: load_pkl(os.path.join(BIN_PATH, get_numerical_scaler_name(key)))
